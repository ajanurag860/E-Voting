...
public class AddCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // dono mein se koi ek null hoga
            String usid=(String)request.getParameter("uid"); 
            // if uid is recieved by the servlet then candidate id is to be fetched and sent else send the city list and candidate name
            ...
            else if(usid!=null)
            {
             try
             {
               ...
               for(String c:city)
               {//Sending options directly to dropdown list
               ...
               out.println(json);
                //sending json object directly to JS. It can also be forwarded by jsp
             }  
             catch(Exception ex)
             {
                 RequestDispatcher  rd=request.getRequestDispatcher("showexception.jsp");             
