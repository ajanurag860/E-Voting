...
//       if(agar nahi mila to register karna ha){
//       }
//       else{ mil gaya to userfound ko true karna ha}
       if(!RegistrationDAO.searchUser(user.getUserid()))  
       {
//           ye !false->true aya ho to registerr karenge
           result=RegistrationDAO.registerUser(user);
           
       }
//       ye(!true)->false aya ho to userfound 
       else{
           userfound=true;
       }
